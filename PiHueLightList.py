...
def putlightstatus(lightstatus):
    ...
    for light in lights:
        b.set_light(light, lightstatus[2])
...
while True:
    if inalert:
        ...
        if islampon():
            print("lamp was found on")
            brightness = 100
            print("Putting green alert...")
            putlightstatus(greenAlert)
            #touchphat.led_on("Back")
        else:
            print("No lamps found on.")
            #touchphat.led_off("Back")
        time.sleep(10)
